...
def main():
    ...
    run_command(f"{sys.executable} -m pip install pytest pytest-cov")
    
    # Run tests
    print("\n=== Running tests ===")
    test_cmd = f"{sys.executable} -m pytest tests/ -v --tb=short --cov=src --cov-report=term --cov-report=xml"
